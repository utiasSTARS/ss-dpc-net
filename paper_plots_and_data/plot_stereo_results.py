...
data_dir = 'best_stereo'
saved_traj = {'00':{}, '02':{}, '05':{}, '06':{}, '08':{}, '09':{}, '10':{}} 
...
for seq in ['00', '02', '05']:
    ...
    order_of_keys = ["Libviso2-s", "Ours (Corrected)"]
    ...
    plt.figure()
    fig, ax = est_vis.plot_topdown(which_plane='xy', outfile = 'figs/{}-seq-{}.pdf'.format(estimator[0],seq), title=r'{}'.format(seq))
